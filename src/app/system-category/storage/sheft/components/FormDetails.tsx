...
export default function FormDetails(props: FormDetailProps) {
    ...
    const { getAllInventories } = useDirectoryContext();
    ...
    return (
        <Dialog open={formSetting.open}
            ...
            <DialogContent className="sm:max-w-[425px] p-4">
                <DialogHeader>
                    <DialogTitle>
                        {formSetting.mode == FormMode.EDIT && 'Cập nhật kệ lưu trữ'}
                        {formSetting.mode == FormMode.ADD && 'Thêm kệ lưu trữ'}
                    </DialogTitle>
                    <DialogDescription>
                        {formSetting.mode == FormMode.EDIT && 'Cập nhật thông tin kệ lưu trữ bằng cách cung cấp thông tin cần thiết.'}
                        {formSetting.mode == FormMode.ADD && 'Nhập thông tin kệ lưu trữ mới vào biểu mẫu dưới đây.'}
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
