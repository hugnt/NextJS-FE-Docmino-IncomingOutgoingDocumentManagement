                    ...
                    <div className="w-full md:max-w-6xl md:mx-auto md:flex md:items-center md:justify-between">
                        ...
                        <div>
                            <div className="hidden md:block">
                                <span className="inline-block py-1 md:py-4 text-gray-600 mr-6 font-bold">Tài liệu đến</span>
                                <span className="inline-block py-1 md:py-4 text-gray-500 hover:text-gray-600 mr-6">Tài liệu đi</span>
                                <span className="inline-block py-1 md:py-4 text-gray-500 hover:text-gray-600 mr-6">Lưu trữ</span>
                                <span className="inline-block py-1 md:py-4 text-gray-500 hover:text-gray-600 mr-6">Blockchain</span>
                            </div>
                        </div>
                        <div className="hidden md:block">
                            <Link href="/login" className="inline-block py-1 md:py-4 text-gray-500 hover:text-gray-600 mr-6">
                                Đăng nhập
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="px-4 py-16">
                        <div className="relative w-full md:max-w-2xl md:mx-auto text-center">
                            <h1 className="font-bold text-gray-700 text-xl sm:text-2xl md:text-5xl leading-tight mb-6">
                                Giải pháp quản lý tài liệu an toàn với công nghệ blockchain
                            </h1>
                            <p className="text-gray-600 md:text-xl md:px-18">
                                Quản lý tài liệu đến và đi minh bạch, bảo mật, không thể giả mạo
                            </p>
