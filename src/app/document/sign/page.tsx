...
import { DocType, ProcessingDocument, ProcessingDocumentFilter } from "@/types/Document";
...
export default function DocumentSignsListPage() {
    const [data, setData] = useState<ProcessingDocument[]>([]);
    ...
    const columns: ColumnDef<ProcessingDocument>[] = [
        {
            id: "index",
            header: "No.",
    ...
    const handleGetList = () => {
        ...
        confirmProcessRequest.getUnconfirmedDocuments(filter).then(res => {
    ...
    return (
        <div>
            <PageHeader title="Danh sách văn bản cần duyệt" subtitle="Các văn bản cần duyệt hiện tại">
                <DropdownMenu>
