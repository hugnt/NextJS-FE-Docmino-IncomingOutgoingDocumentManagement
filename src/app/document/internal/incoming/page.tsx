...
export default function DocumentInternalIncomingPage() {
    ...
    const [filter, setFilter] = useState<InternalDocumentFilter>({ documentType: DocType.InternalIncoming, pageNumber: 1, pageSize: 10 });
    ...
    return (
        <div>
            <PageHeader title="Văn bản nội bộ đến" subtitle="Danh sách văn bản đến trong nội bộ công ty">
                {hasInternalDocumentRight&&<Link href={`${PATH.DocumentInternalIncoming}/create`} target="_blank">
