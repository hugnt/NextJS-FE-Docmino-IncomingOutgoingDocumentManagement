...
import { defaultInternalDocumentDetail, InternalDocumentDetail } from "@/types/InternalDocument"
...
export default function InternalDocumentDetailPage() {
    ...
    const form = useForm<InternalDocumentDetail>({ defaultValues: defaultInternalDocumentDetail })
    ...
    const handleSave = (data: InternalDocumentDetail) => {
        console.log(data)
        setLoadingSave(true)
    ...
    const handleReload = () => {
        ...
        else form.reset(defaultInternalDocumentDetail);
    }
            ...
            {loading ? <DocumentFormSkeleton /> :
                <Form {...form}>
                    <form id='document-form'
                        ...
                        <PageHeader
                            title={id && id !== "create" ? "Chi tiết văn bản đi" : "Thêm văn bản đi"}
                            subtitle={id && id !== "create" ? "Chi tiết thông tin văn bản đi" : "Thêm mới văn bản đi"}>
            ...
            <ConfirmDialog
                ...
                desc={
                    <>
                        ...
                        Quá trình này sẽ gửi văn bản đi các người dùng đã được chỉ định trong quy trình duyệt. <br />
