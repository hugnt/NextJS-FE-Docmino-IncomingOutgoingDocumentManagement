      ...
      <div className="col-span-2 grid grid-cols-2 gap-3">
        ...
        <div className="grid grid-cols-2 gap-3">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='space-y-1'>
                <FormLabel>Số đến</FormLabel>
                <FormControl>
                  <Input readOnly={readOnly} {...field} placeholder='Nhập số đến' />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select
                ...
                <FormControl className="w-full">
                  <SelectTrigger disabled={readOnly}>
                    <SelectValue placeholder="Chọn cơ quan ban hành văn bản" />
                  </SelectTrigger>
                </FormControl>
                <SelectContent >
                  {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className='space-y-1'>
              <FormLabel>Đơn vị hoặc người nhận văn bản</FormLabel>
              <FormControl>
                <Input readOnly={readOnly} {...field} placeholder='Nhập tên đơn vị hoặc người nhận văn bản' />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
      ...
      <div>
        <div className="grid  grid-cols-3  gap-3">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='space-y-1'>
                <FormLabel>Ngày ký văn bản</FormLabel>
                <FormControl>
                  <DatePicker
                    value={field.value}
                    onChange={field.onChange}
                    placeholder={"Chọn ngày ký văn bản"}
                    disabled={readOnly}
                  />
                </FormControl>
                <FormMessage />
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className='space-y-1'>
                <FormLabel>Hạn giải quyết</FormLabel>
                <FormControl>
                  <DatePicker
                    value={field.value}
                    onChange={field.onChange}
                    placeholder={"Chọn dealine"}
                    defaultToday={false}
                    disabled={readOnly}
                  />
                </FormControl>
